  ...
  describe('Part II --- LOGICAL', function() {
    ...
    describe('same', function() {
      ...
      it('are the parameters equal ', function() {
        ...
        expect(_.same(13,true)).to.equal(true);
    ...
    describe('TEST ONLY: Array Matrix', function() { 
      ...
      it('TEST ONLY: Access the Array\'s Values', function(){
        expect(arryMtrx[1][1]).to.eql(1);
        expect(arryMtrx[3][3]).to.eql(9);
        expect(arryMtrx[2][5]).to.eql(5);
        expect(arryMtrx[2][1]).to.eql(4);
        expect(arryMtrx[3][2]).to.eql(8);
        expect(arryMtrx[1][2]).to.eql(2);
      });
